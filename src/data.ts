...
export const products: Product[] = [
  {
    ...
    badge: "Best Seller",
    featured: true,
    images: [images.products.classic, images.products.classicBack],
  ...
  },
  {
    ...
    badge: "Spicy Pick",
    featured: true,
    images: [images.products.periPeri, images.products.periPeriBack],
  ...
  },
  {
    ...
    badge: "Flavour Note",
    featured: false,
    images: [images.products.cheese, images.products.cheeseBack],
    variants: ["100 g"],
  ...
  },
  {
    ...
    featured: false,
    images: [images.products.salted, images.products.saltedBack],
  ...
  },
  {
    ...
    badge: "New",
    featured: false,
    images: [images.products.chocolate, images.products.chocolateBack],
    variants: ["100 g"],
